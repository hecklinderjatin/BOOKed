...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
		...
		<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-toggle="dropdown">Fine Calculation</a>
    <div class="dropdown-menu">
        <!-- Fine calculation options -->
        <a class="dropdown-item" href="#" id="calculateFine">Calculate Fine</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="#" id="viewFineHistory">View Fine History</a>
    </div>
</li>
